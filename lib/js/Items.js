...
Zotero.Items.prototype.writeItems = function(itemsArray){
    ...
    sequentialD.done(J.proxy(function(sequentialDeferreds){
        //TODO: writeItemsDeferred previously resolved with returned items
        //this is harder when it's coming back over multiple requests. Not sure
        //if it's worth it yet to return that behaviour with multi-request
        writeItemsDeferred.resolve(returnItems);
    }, this));
    /*
